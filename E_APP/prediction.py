...
def getModel(model_name):
    if model_name == 'decision-tree':
        model = 'static/decision_tree_model.sav'
    elif model_name == 'gradient-boosting':
        model = 'static/gradient_boosting_model.sav'
    elif model_name == 'random-forest':
        model = 'static/random_forest_model.sav'
...
def train_model(student_information):
    df_final = pd.read_csv('static/final_pre_processed_data_encoded.csv')
